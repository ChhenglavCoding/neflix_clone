...
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-12 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-red-600 text-2xl md:text-4xl font-bold", children: "NETFLIX" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "english", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectTrigger, { className: "w-auto bg-transparent border border-white/30 text-white", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "spanish", children: "Khmer" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded", children: "Sign In" })
    ] })
  ] });
}
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-5xl lg:text-6xl font-bold mb-4", children: "Unlimited movies, TV shows, and more" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl mb-4", children: "Starts at $7.99. Cancel anytime." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base md:text-lg mb-8", children: "Ready to watch? Enter your email to create or restart your membership." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 max-w-lg mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "email",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "bg-red-600 hover:bg-red-700 text-white px-6 h-12 text-lg font-medium", children: [
          "Get Started",
...
function TrendingSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 px-4 md:px-12 bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-8", children: "Trending Now" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto scrollbar-hide", children: trendingShows.map((show) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 relative group cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: show.image,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 -left-4 text-6xl md:text-8xl font-black text-white stroke-2 stroke-gray-800", children: show.rank })
      ] }) }, show.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
...
function FeaturesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4 md:px-12 bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-12 text-center", children: "More Reasons to Join" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 p-6 rounded-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(feature.icon, { className: "w-6 h-6 text-white" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-3", children: feature.title }),
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from $6.99 to $22.99 a month."
  },
  {
...
function FAQSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4 md:px-12 bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-8 text-center", children: "Frequently Asked Questions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-12", children: faqs.map((faq, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-800 rounded-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg md:text-xl font-medium", children: faq.question }),
            openIndex === index ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-6 h-6 flex-shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-6 h-6 flex-shrink-0" })
          ]
        }
      ),
      openIndex === index && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-lg leading-relaxed", children: faq.answer }) })
    ] }, index)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-6", children: "Ready to watch? Enter your email to create or restart your membership." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 max-w-lg mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-16 px-4 md:px-12 bg-black border-t border-gray-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-8", children: "Questions? Call 1-866-952-4456" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: footerLinks.map((column, columnIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: column.map((link, linkIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: "#",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "english", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectTrigger, { className: "w-auto bg-transparent border border-gray-600 text-gray-400", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-4 h-4 mr-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm", children: "Netflix Cambodia" })
  ] }) });
}
